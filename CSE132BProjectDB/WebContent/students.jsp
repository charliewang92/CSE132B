            ...
            <%
                ...
                try {
                   ...
                   DriverManager.registerDriver(new com.microsoft.sqlserver.jdbc.SQLServerDriver());
                    ...
                    Connection conn = DriverManager.getConnection("jdbc:sqlserver://137.110.91.245:1433; databaseName=master", 
                            "cvll", "password123");
            %>                  
            ...
            <%	
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "INSERT INTO Student (id, first_name, last_name, middle_name, ssn, residency) VALUES (?, ?, ?, ?, ?, ?)");
                       ...
                       pstmt.setString(4, request.getParameter("MIDDLENAME"));
                        ...
                        pstmt.setInt(6, Integer.parseInt(request.getParameter("RESIDENCY")));
